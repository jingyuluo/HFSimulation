...
# List of datasets
datasetnames = [
'/HFSim_Phase2/jingyu-SingleNeutrino_forHF_RAWSIM_phase2_PU175_noaging-20325a6891d61aae2e06c0128bdc626c/USER'
...
config.General.requestName     = 'HFSim_Phase2_PU175_Ntuple_noaging'#dataset[0]+'_'+dataset[1]+'_'+dataset[2]+timestamp
...
config.Data.outputDatasetTag = 'HFSim_Phase2_PU175_Ntuple_noaging'#dataset[1]+'_'+dataset[2]+timestamp
