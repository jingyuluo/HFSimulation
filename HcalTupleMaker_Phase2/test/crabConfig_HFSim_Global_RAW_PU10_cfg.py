...
config.General.requestName     = 'HFSim_Phase2_PU10_Ntuple_fixed'#dataset[0]+'_'+dataset[1]+'_'+dataset[2]+timestamp
...
config.Data.outputDatasetTag = 'HFSim_Phase2_PU10_Ntuple_fixed'#dataset[1]+'_'+dataset[2]+timestamp
