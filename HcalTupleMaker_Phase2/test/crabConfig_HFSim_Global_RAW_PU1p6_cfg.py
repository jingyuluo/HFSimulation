...
# List of datasets
datasetnames = [
'/HFSim_Phase2/jingyu-SingleNeutrino_forHF_RAWSIM_PU1p6_phase2-6dde8b71e9ba45e3a6f4102e221060e3/USER',
...
config.General.requestName     = 'HFSim_Phase2_PU1p6_Ntuple_fixed'#dataset[0]+'_'+dataset[1]+'_'+dataset[2]+timestamp
...
config.Data.outputDatasetTag = 'HFSim_Phase1p6_PU5_Ntuple_fixed'#dataset[1]+'_'+dataset[2]+timestamp
