...
# List of datasets
datasetnames = [
'/HFSim_Phase2/jingyu-SingleNeutrino_forHF_RAWSIM_PU0p2_phase2-ce4cecf61896208bb9cce25048ed8872/USER'
...
config.General.requestName     = 'HFSim_Phase2_PU0p2_Ntuple_fixed'#dataset[0]+'_'+dataset[1]+'_'+dataset[2]+timestamp
...
config.Data.outputDatasetTag = 'HFSim_Phase0p2_PU5_Ntuple_fixed'#dataset[1]+'_'+dataset[2]+timestamp
