...
config.Data.outputPrimaryDataset = 'HFSim_Phase2'
...
config.Data.outLFNDirBase = '/store/group/lpcbril/MC_test/HFSim_GENSIM' 
...
config.JobType.psetName = "SingleNeutrino_forHF_GENSIM_cfg.py"
config.General.requestName = "SingleNeutrino_forHF_GENSIM_phase2"
config.Data.outputDatasetTag = "SingleNeutrino_forHF_GENSIM_phase2"
...
#
#for m in [600, 800, 1000, 1200, 1400, 1600, 1800, 2000]:#[1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000]:
